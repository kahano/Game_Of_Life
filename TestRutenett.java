...
public class TestRutenett {
        ...
        private static void testKonstruktoerUtenRutenett() {
            ...
            sjekk("testRutenett.antRader==3", testRutenett.get_AntRader()==3);
            sjekk("testRutenett.antKolonner==5", testRutenett.get_AntKolonner()==5);
        ...
        private static void testFyllMedTilfeldigeCeller() {
            ...
            for (int rx = 0;  rx < testRutenett.get_AntRader();  ++rx) {
                for (int kx = 0;  kx < testRutenett.get_AntKolonner();  ++kx) {
    ...
    private static void testHentCelle () {
        ...
        for (int rx = -1;  rx < testRutenett.get_AntRader()+1;  ++rx) {
            for (int kx = -1;  kx < testRutenett.get_AntKolonner()+1;  ++kx) {
    ...
    private static void testKobleAlleCeller () {
        ...
        for (int rx = 0;  rx < testRutenett.get_AntRader();  ++rx) {
            for (int kx = 0;  kx < testRutenett.get_AntKolonner();  ++kx) {
                totaltAntallNaboer += testRutenett.hentCelle(rx,kx).hent_antNaboer();

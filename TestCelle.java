...
public class TestCelle {
    ...
    private static void testLeggTilNabo () {
        ...
        sjekk("celle.antNaboer==1", celle.hent_antNaboer()==1);
        //System.out.println("total: " + celle.hent_antNaboer());
        celle.leggTilNabo(nabo2);
        System.out.println("naboer: " + Arrays.toString(celle.hentnaboer()));
        sjekk("celle.antNaboer==2", celle.hent_antNaboer()==2);
